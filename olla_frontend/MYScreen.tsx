...
const MyPageScreen = ({ navigation }: any) => {
  ...
  // 정보 입력 State
  const [valName, setValName] = useState('권클라이밍');
  const [valPhone, setValPhone] = useState('010-1234-5678');
  const [valAge, setValAge] = useState('25');
  const [valHeight, setValHeight] = useState('175');
  const [valWeight, setValWeight] = useState('70');
  const [valArm, setValArm] = useState('180');
  const [valShoe, setValShoe] = useState('260');
  ...
  const closeProfileModal = () => {
    Animated.timing(profileSlideAnim, { toValue: 800, duration: 250, useNativeDriver: true }).start(() => {
  ...
  return (
    <SafeAreaView style={styles.background}>
        ...
        <TouchableOpacity style={styles.profileCard} activeOpacity={0.8} onPress={openProfileModal}>
          <View style={styles.profileLeft}>
            ...
            <View style={styles.profileTextContainer}>
              <Text style={styles.profileName}>{valName}</Text>
              <Text style={styles.profileEmail}>{valPhone === '010-1234-5678' ? 'io8272@naver.com' : valPhone}</Text>
            </View>
          </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.memInfoContainer}>
            <View style={styles.memInfoRow}>
              ...
              <Text style={styles.memInfoValue}>2개월</Text>
            </View>
            <View style={styles.memInfoRow}>
              <Text style={styles.memInfoLabel}>기간</Text>
              <Text style={styles.memInfoValue}>2026-02-01 ~ 2026-04-01</Text>
            </View>
            <View style={styles.memInfoRow}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.settingRow}>
            <View style={styles.settingTextContainer}>
              ...
              <Text style={styles.settingSub}>랭킹 변동, 주간 리포트, 모임 관련 알림, 미활동 알림</Text>
            </View>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch trackColor={{ false: '#333333', true: '#A1BE44' }} thumbColor={isNoticeEnabled ? '#ffffff' : '#f4f3f4'} onValueChange={() => setIsNoticeEnabled(!isNoticeEnabled)} value={isNoticeEnabled} />
          </View>

          <View style={styles.settingRow}>
            <View style={styles.settingTextContainer}>
              <Text style={styles.settingTitle}>멤버십 만료 알림</Text>
              <Text style={styles.settingSub}>만료 일주일, 1일 전, 당일 알림</Text>
            </View>
            <Switch trackColor={{ false: '#333333', true: '#A1BE44' }} thumbColor={isExpireEnabled ? '#ffffff' : '#f4f3f4'} onValueChange={() => setIsExpireEnabled(!isExpireEnabled)} value={isExpireEnabled} />
          </View>
        </View>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.bottomNavItem} onPress={() => navigation.navigate('MyPage')}>
          ...
          <Animated.View style={[styles.bottomSheet, { transform: [{ translateY: contactSlideAnim }] }]}>
            <TouchableOpacity activeOpacity={1} style={{ width: '100%', alignItems: 'center' }}>
              ...
              <View style={styles.contactContentBox}>
                ...
                <Text style={styles.contactTime}>프론트 운영시간: 10:00 ~ 22:00</Text>
              </View>
              <View style={styles.modalBtnRow}>
            ...
            <TouchableOpacity activeOpacity={1} style={{ width: '100%' }}>
              ...
              <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 20 }}>
                <View style={styles.profileEditContainer}>
                  ...
                  <TouchableOpacity style={styles.saveProfileButton} onPress={closeProfileModal}>
...
const styles = StyleSheet.create({
  ...
  // 💡 topNav 정렬을 다른 창들과 똑같이 space-between으로 변경했습니다.
  ...
  topIcon: { width: 24, height: 24, resizeMode: 'contain' }, // 💡 아이콘 스타일 추가
